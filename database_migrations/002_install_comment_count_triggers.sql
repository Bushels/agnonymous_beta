-- ============================================================================
-- INSTALL COMMENT COUNT TRIGGERS
-- ============================================================================
...
BEGIN
  ...
  IF insert_trigger_exists AND delete_trigger_exists THEN
    RAISE NOTICE '✅ Comment count triggers installed successfully';
  ELSE
...
RAISE NOTICE '✅ Migration 002_install_comment_count_triggers.sql completed successfully';
